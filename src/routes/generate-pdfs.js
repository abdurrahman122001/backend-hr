...
const PATH_FIELD_BY_TYPE = {
  nda: "ndaPath",
  contract: "contractPath",
  salary_certificate: "salaryCertificatePath",
...
function printMetaLeft(doc, fonts, dateString, docNumber, metaSize = SIZES.meta) {
  ...
  doc
    .font(fonts.regular)
    .fontSize(metaSize)
    .text(leftText, xLeft, y0, { width: half, align: "left" });
  doc
    .font(fonts.regular)
    .fontSize(metaSize)
    .text(rightText, xRight, y0, { width: half, align: "right" });
...
async function writeNda(doc, emp) {
  ...
  const blocks = [
    ...
    {
      t: "WHEREAS the parties to this Agreement wish to exchange certain confidential and proprietary information for the purpose of entering into discussions regarding a potential business relationship.",
      b: false,
      i: 0,
    },
    ...
    {
      t: '"Owner" means the party hereto which possesses the intellectual property rights or other proprietary rights in and to an item of Confidential Information, as the context requires, and includes, without limitation, an owner, possessor, developer and licensee of such Confidential Information.',
      b: false,
      i: 10,
    },
    {
      t: '"Recipient" means the party hereto who receives or is otherwise privy to, or comes into possession of, an item of Confidential Information of which it is not the Owner.',
      b: false,
      i: 10,
    },
    {
    ...
    {
      t: "3. Recipient shall not, without the prior written consent of the Owner, disclose any Confidential Information to any person or entity other than:",
      b: false,
      i: 0,
    },
    {
    ...
    {
      t: "b) As required pursuant to any law, court order or other legal compulsion, provided that, prior to such disclosure, Recipient shall first notify Owner in writing of such disclosure requirement and assist the Owner in protecting such Confidential Information from disclosure.",
      b: false,
      i: 10,
    },
    {
    ...
    {
      t: "4. The Confidential Information shall not be copied, reproduced in any form or stored in a retrieval system or data base by the Recipient without prior written consent of the Owner, except for such copies and storage as may reasonably be required internally by Recipient for the Purpose.",
      b: false,
      i: 0,
    },
    {
    ...
    {
      t: "7. Neither this Agreement nor the disclosure of any Confidential Information to Recipient shall be construed as granting to Recipient any rights in, to or in respect of the Confidential Information.",
      b: false,
      i: 0,
    },
    {
    ...
    {
      t: "9. The parties agree that the execution of this Agreement does not in any way constitute a partnership or joint venture or binding commitment on the part of either party to enter into or complete negotiations or any transaction with the other party.",
      b: false,
      i: 0,
    },
    {
    ...
    {
      t: "11. This Agreement shall be binding upon the trustees, receiver, heirs, executors, administrators, successors and assigns of the parties.",
      b: false,
      i: 0,
    },
    {
      t: "12. This Agreement shall be exclusively governed by, and construed in accordance, with the laws of the province of Sindh and the laws of Pakistan applicable therein. The parties hereby submit to the exclusive jurisdiction of the courts of the province of Sindh.",
      b: false,
      i: 0,
    },
    {
    ...
    {
      t: "14. No waiver of any breach of any provision of this Agreement will be effective or binding unless in writing and signed by party purporting to give the same and will be limited to the specific breach waived unless otherwise provided in the written waiver.",
      b: false,
      i: 0,
    },
    {
      t: "15. The Receiving Party affirms that the individual(s) executing this Agreement has the authority to bind the Receiving Party to the terms hereof.",
      b: false,
      i: 0,
    },
    {
    ...
    {
      t: "17. This Agreement will be effective as of the Effective Date, but will apply to any Confidential Information disclosed to the Receiving Party by Company prior to such date.",
      b: false,
      i: 0,
    },
    {
      t: "(a) as to subsequent disclosures of Confidential Information, on the later of five (5) years from and after the Effective Date or five (5) years from the expiry or termination of any other agreement between the Parties related to the supply of goods and/or services in relation to the Permitted Purpose.",
      b: false,
      i: 10,
    },
    {
    ...
    {
      t: "18. An electronic copy or facsimile of a party's signature shall be binding upon the signatory with the same force and effect as an original signature.",
      b: false,
      i: 0,
    },
  ];
  ...
  blocks.forEach(({ t, b, i }) => {
    doc
      .font(b ? fonts.bold : fonts.regular)
      .fontSize(SIZES.body)
      .text(t, doc.page.margins.left + (i || 0), undefined, lineOpts(i || 0));
    doc.moveDown(0.6);
  });
...
async function writeContract(doc, emp, slip, key = null) {
  ...
  const companyName = data.companyName || "Mavens Advisor Pvt. Ltd.";
  const probationMonths = Number.isFinite(+data.probationMonths)
    ? +data.probationMonths
    : emp.probationMonths ?? 3;
  ...
  if (key && slip) {
    try {
      ...
      conveyance = slip.conveyanceAllowance
        ? await decrypt(slip.conveyanceAllowance, key)
        : "0";
    } catch {
      gross = "0";
      conveyance = "0";
  ...
  doc
    .font(fonts.bold)
    .fontSize(SIZES.h1)
    .text("EMPLOYMENT CONTRACT: PRIVATE AND CONFIDENTIAL", {
      align: "center",
    });
  ...
  doc
    .font(fonts.regular)
    .fontSize(SIZES.body)
    .text("(1) Your monthly salary and allowances payable monthly in arrear will be:", {
      align: "left",
      lineGap: 3,
    });
  doc.moveDown(0.6);
  ...
  doc.text("Basic Compensation", x0 + 6, y0 + 3, {
    width: col1 - 12,
    align: "left",
  });
  doc.text(
    `Rs. ${Number(gross || 0).toLocaleString()}`,
    x0 + col1 + 6,
    y0 + 3,
    { width: col2 - 12, align: "left" }
  );

  doc.text("Conveyance Allowance", x0 + 6, y0 + rowH + 3, {
    width: col1 - 12,
    align: "left",
  });
  doc.text(
    `Rs. ${Number(conveyance || 0).toLocaleString()}`,
    x0 + col1 + 6,
    y0 + rowH + 3,
    { width: col2 - 12, align: "left" }
  );
  ...
  const p = (t, bold = false, indent = 0) => {
    doc
      ...
      .fontSize(SIZES.body)
      .text(t, x0 + indent, undefined, {
        width: tableWidth - indent,
        align: "left",
        lineGap: 3,
      });
    doc.moveDown(0.6);
  ...
  p(
    `(7) Your employment with the Company is at all times conditional upon your promptly producing references to the satisfaction of the Company and the Company determining that the outcome of any background checks which the Company may conduct, are to its satisfaction.`
  );
  p(
    `(8) You agree to be bound by the Company's rules, regulations and policies as amended, modified or adopted from time to time.`
  );
  p(`(9) Working Hours:`, true);
  p(
    `(a) Working days in the Company will be 6 days a week (${workDays}) i.e. from Monday to Saturday. Office hours will be from ${officeStart} to ${officeEnd} without any break for lunch. However, these working days/timings may be varied for different staff members with mutual agreement based upon his/her types of responsibilities.`,
    false,
    10
  );
  p(
    `(b) Sunday is normally a full holiday, however as per the workload, the management of Mavens Advisor may call you on holidays.`,
    false,
    10
  );
  p(
  ...
  p(
    `(a) Except in the proper performance of your duties or as required in law, you may not (and undertake that you will not), during or after your employment, disclose or otherwise make use of (and shall use your best endeavors to prevent the publication or disclosure of) any trade secrets or other confidential information of or relating to the Company or any of its subsidiaries or affiliates, or any other person or entity, including any organization or business with which the Company is involved in any kind of business venture or partnership or any information concerning the business of the Company or any Associated Entity or in respect of which the Company owes an obligation of confidence to any third party.`,
    false,
    10
  );
  p(
    `(b) You must not at any time remove from the Company's premises any documents or items which belong to the Company or which contain any Confidential Information without proper advance authorization from the administrator.`,
    false,
    10
  );
  p(
    `(c) You must return to the Company upon request and, in any event, upon the termination of your employment, all documents, records and other papers (including copies and extracts), items and other property of whatsoever nature which belong to the Company or which contain or refer to any confidential information and which are in your possession or under your control.`,
    false,
    10
  );
  p(
    `(12) You acknowledge that all Intellectual Property Rights, inventions and all materials embodying them shall automatically belong to the Company to the fullest extent permitted by law.`
  );
  p(`(13) This letter of employment shall be governed by the laws of Pakistan.`);
  p(
    `(14) You are not allowed to be involved in any business activity, whether it is as a buyer, supplier or employee/employer with a company that is in the same business as for the duration of your employment.`
  );
  p(
    `(15) By signing this agreement, you are endorsing the fact that you will work for the Company for at least ONE year in the current capacity and will not resign from the current or seek any other kind of employment opportunity during this period.`
  );
...
async function writeSalaryCertificate(doc, emp, issueDate, joinDate, monthlySalary) {
  ...
  const totalSalary =
    overrideSalary && String(overrideSalary).trim() !== ""
      ? overrideSalary
      : monthlySalary;
  ...
  const details =
    ...
    `Total Monthly Salary: ${
      totalSalary ? Number(totalSalary).toLocaleString() + " PKR" : "XX,XXX PKR"
    }`;

  doc.font(fonts.regular).fontSize(SIZES.body).text(details, {
    align: "left",
    lineGap: 3,
  });
...
async function writeExperienceLetter(
  doc,
  emp,
  issueDate,
  joinDate,
  ...
  sizes,
  bodyLineGap = 2.4,
  headerGapLines = HEADER_GAP_LINES,
  linesBetweenParas = 2.0,
  headingGapLines = 3,
  signGapAfterRegards = 7,
  gapBeforeHeadingLines = 1.0,
  extraAfterHeadingLines = 0.8
) {
  const fonts = setupFonts(doc);
  if (!emp || !emp.name)
    throw new Error("Employee name missing for Experience Letter");
  ...
  const qualitiesLine =
    data.qualitiesLine || `…hardworking, punctual, precise, and honest.`;
  const fullBody = (data.fullBody || "").toString();
  ...
  doc
    ...
    .text("To whom it may concern", doc.page.margins.left, undefined, {
      width: contentWidth,
      align: "center",
      underline: true,
    });
  ...
  const para = (t) => {
    doc.font(fonts.regular).fontSize(sizes.body).text(t, doc.page.margins.left, undefined, bodyOpts);
    doc.moveDown(linesBetweenParas);
  };

  // If a custom body was saved, print that verbatim and skip the templated paragraphs
  if (fullBody.trim().length > 0) {
    ...
    normalized.forEach((line) => {
      doc
        .font(fonts.regular)
        .fontSize(sizes.body)
        .text(line || " ", doc.page.margins.left, undefined, bodyOpts);
    });
  } else {
    ...
    if (!wroteTimeline && (emp.designation || emp.position)) {
      para(`${name} served as ${emp.designation || emp.position}.`);
    }
...
async function generateSalaryCertificatePdf(employee) {
  ...
  const pdfPath = path.join(
    UPLOAD_DIR,
    `salary_certificate_${employee._id}.pdf`
  );
  const doc = new PDFDocument({ size: "A4", margin: DEFAULT_MARGINS });
  doc.pipe(fs.createWriteStream(pdfPath));
...
async function generateExperienceLetterPdf(employee) {
  if (!employee || !employee.name || !employee.cnic)
    throw new Error(
      "Employee name or CNIC missing for Experience Letter PDF"
    );
  ...
  const startIso =
    employee.joiningDate || employee.startDate || employee.hireDate || null;
  const endIso =
...
/* ======================= DOC CRUD API ===================== */
/**
 * GET /docs/:type/:employeeId
 * Returns saved data (including any custom fullBody) for this employee+type.
 */
router.get("/docs/:type/:employeeId", async (req, res) => {
  try {
    ...
    const found = await EmployeeDoc.findOne({ employee: employeeId, type }).lean();
    return res.json({ data: found?.data || {} });
  } catch (err) {
    res.status(err.status || 500).json({ message: err.message || "Failed to fetch doc data" });
  }
});

/**
 * POST /docs/:type/:employeeId
 * Upserts the data for this employee+type (stores content too),
 * and clears the cached PDF path so the next generate reflects changes.
 * Body: { data: { ... } }
 */
router.post("/docs/:type/:employeeId", async (req, res) => {
  try {
    const { type, employeeId } = req.params;
    validateType(type);
    ...
    // Upsert EmployeeDoc
    const saved = await EmployeeDoc.findOneAndUpdate(
      { employee: employeeId, type },
      { $set: { data: payload } },
      { new: true, upsert: true }
    ).lean();

    // Clear any previously cached path on Employee for this type
    const pathField = PATH_FIELD_BY_TYPE[type];
    if (pathField) {
    ...
    return res.json({ data: saved.data || {} });
  } catch (err) {
    res.status(err.status || 500).json({ message: err.message || "Failed to save doc data" });
  }
});

/* =============== PDF ROUTES (non-/generate) =============== */
router.get("/nda/:employeeId", async (req, res) => {
  try {
    ...
    if (!emp.name || !emp.cnic)
      return res
        .status(400)
        .json({ message: "Employee name or CNIC is missing" });
    ...
    res.set(
      "Content-Disposition",
      `inline; filename=NDA_${emp.name || "Unknown"}.pdf`
    );
...
router.get("/contract/:employeeId", async (req, res) => {
  try {
    ...
    res.set(
      "Content-Disposition",
      `inline; filename=Contract_${emp.name || "Unknown"}.pdf`
    );
    res.sendFile(path.resolve(contractPath));
  } catch (err) {
    res
      .status(500)
      .json({ message: `Failed to generate contract: ${err.message}` });
  }
});
...
router.get("/salary-certificate/:employeeId", async (req, res) => {
  try {
    ...
    if (!certPath || !fs.existsSync(certPath)) {
      ...
      await Employee.updateOne(
        { _id: req.params.employeeId },
        { $set: { salaryCertificatePath: certPath } }
      );
    }
    ...
    if (!fs.existsSync(certPath))
      return res
        .status(500)
        .json({ message: "Failed to generate salary certificate" });

    res.set("Content-Type", "application/pdf");
    res.set(
      "Content-Disposition",
      `inline; filename=SalaryCertificate_${emp.name || "Unknown"}.pdf`
    );
    ...
    res
      .status(500)
      .json({
        message: `Failed to generate salary certificate: ${err.message}`,
      });
  }
});
...
router.get("/experience-letter/:employeeId", async (req, res) => {
  try {
    ...
    if (!expPath || !fs.existsSync(expPath)) {
      ...
      await Employee.updateOne(
        { _id: req.params.employeeId },
        { $set: { experienceLetterPath: expPath } }
      );
    }
    ...
    if (!fs.existsSync(expPath))
      return res
        .status(500)
        .json({ message: "Failed to generate experience letter" });

    res.set("Content-Type", "application/pdf");
    res.set(
      "Content-Disposition",
      `inline; filename=ExperienceLetter_${emp.name || "Unknown"}.pdf`
    );
    ...
    res
      .status(500)
      .json({
        message: `Failed to generate experience letter: ${err.message}`,
      });
  }
});

/* ===== Mirror endpoints under /generate/* so frontend URLs keep working ===== */
router.get("/generate/nda/:employeeId", (req, res, next) =>
  router.handle({ ...req, url: `/nda/${req.params.employeeId}`, method: "GET" }, res, next)
);
router.get("/generate/contract/:employeeId", (req, res, next) =>
  router.handle({ ...req, url: `/contract/${req.params.employeeId}`, method: "GET" }, res, next)
);
router.post("/generate/contract/:employeeId", (req, res, next) =>
  router.handle({ ...req, url: `/contract/${req.params.employeeId}`, method: "POST" }, res, next)
);
router.get("/generate/salary-certificate/:employeeId", (req, res, next) =>
  router.handle({ ...req, url: `/salary-certificate/${req.params.employeeId}`, method: "GET" }, res, next)
);
router.get("/generate/experience-letter/:employeeId", (req, res, next) =>
  router.handle({ ...req, url: `/experience-letter/${req.params.employeeId}`, method: "GET" }, res, next)
);
