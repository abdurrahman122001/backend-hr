...
const payrollHierarchyRoute = require("./routes/payrollHierarchy");
...
const clientEmployeesRoutes = require("./routes/clientEmployees");
...
app.use("/api/client-employees", clientEmployeesRoutes);
...
const whistleblowingReportRoutes = require("./routes/whistleblowingReportRoutes");
...
app.use("/api/payroll-hierarchy", anyPayrollAuth, payrollHierarchyRoute);
