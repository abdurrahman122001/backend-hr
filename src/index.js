...
const app = express();
const offerEmailRoutes = require("./routes/offerEmail");
const offerEmailsRoutes = require("./routes/offerEmails");
...
app.use(
  cors({
    origin: ["http://admin.virsme.com", "http://admin.innand.com", "http://apis.innand.com", "http://employee.virsme.com", "http://hr.virsme.com", "http://localhost:8080", "http://innand.com", "http://localhost:8081", "http://localhost:8082", "http://localhost:8083"],
...
app.use("/api/offer-email", offerEmailRoutes);
app.use("/api/offer-emails", offerEmailsRoutes);
