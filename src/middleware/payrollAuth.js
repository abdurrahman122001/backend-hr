// backend/src/middleware/payrollAuth.js
...
/**
 * payrollAuth
 * Allows ONLY employees with delegated PayrollAccess
 * Admin/HR users are blocked and shown "oops we didn't find anything"
 * Follows the same pattern as attendanceAuth
 */
module.exports = async function payrollAuth(req, res, next) {
    ...
    try {
        ...
        console.error("🔐 [PayrollAuth] Error:", err.message);
